...
#define DISABLE_WDOG    1//FSL: needed at startup

#define CLOCK_SETUP     3//dummy definition to avoid clk config here
...
#else/*FSL: dummy definition*/
  #define CPU_XTAL_CLK_HZ                 0u       /* Value of the external crystal or oscillator clock frequency in Hz */
  #define CPU_XTAL32k_CLK_HZ              0u       /* Value of the external 32k crystal or oscillator clock frequency in Hz */
  #define CPU_INT_SLOW_CLK_HZ             0u       /* Value of the slow internal oscillator clock frequency in Hz  */
  #define CPU_INT_FAST_CLK_HZ             0u       /* Value of the fast internal oscillator clock frequency in Hz  */
  #define DEFAULT_SYSTEM_CLOCK            0u       /* Default System clock value */
#endif /* (CLOCK_SETUP == 2) */
