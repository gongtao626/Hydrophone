...
; *           Freescale MK60N512VMD100 device
; * @version: V1.1
...
Stack_Size      EQU     (1*1024)           ;new! b06862: 1KB
...
__Vectors       DCD     __initial_sp  ; Top of Stack
                ...
                DCD     RNGB_IRQHandler  ; RNGB Interrupt
                ...
                DCD     CAN0_IMEU_IRQHandler  ; CAN0 Individual Matching Elements Update (IMEU) Interrupt
                DCD     CAN0_Lost_Rx_IRQHandler  ; CAN0 Lost Receive Interrupt
                ...
                DCD     CAN1_IMEU_IRQHandler  ; CAN1 Individual Matching Elements Update (IMEU) Interrupt
                DCD     CAN1_Lost_Rx_IRQHandler  ; CAN1 Lost Receive Interrupt
...
Reset_Handler   PROC
                ...
                IMPORT  SystemInit
                IMPORT  __main
                LDR     R0, =SystemInit                ;only disable watchdog
                BLX     R0
                LDR     R0, =__main;
                BX      R0
                ENDP
...
Default_Handler PROC
                ...
                EXPORT  CAN0_IMEU_IRQHandler     [WEAK]
                EXPORT  CAN0_Lost_Rx_IRQHandler     [WEAK]
                ...
                EXPORT  CAN1_IMEU_IRQHandler     [WEAK]
                EXPORT  CAN1_Lost_Rx_IRQHandler     [WEAK]
                ...
                EXPORT  HSCMP0_IRQHandler     [WEAK]
                EXPORT  HSCMP1_IRQHandler     [WEAK]
                EXPORT  HSCMP2_IRQHandler     [WEAK]
